	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_frpexample_domain_model_item',
				'foreign_table_where' => 'AND tx_frpexample_domain_model_item.pid=###CURRENT_PID### AND tx_frpexample_domain_model_item.sys_language_uid IN (-1,0)',
			),
		),
		...
		'title' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:frp_example/Resources/Private/Language/locallang_db.xlf:tx_frpexample_domain_model_item.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'production_date' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:frp_example/Resources/Private/Language/locallang_db.xlf:tx_frpexample_domain_model_item.production_date',
			'config' => array(
				'type' => 'input',
				'size' => 10,
				'eval' => 'datetime',
		...
		'groups' => array(
			...
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'tx_frpexample_domain_model_group',
				'minitems' => 0,
				'maxitems' => 1,
			),
		),
